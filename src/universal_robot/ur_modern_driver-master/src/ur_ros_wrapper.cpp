...
public:
	RosWrapper(std::string host, int reverse_port) :
      ...
      ur5_publisher = nh_.advertise<std_msgs::String>("ur5", 1);
      ros::Rate rate(20);
      cmsg.data = " ..Connected";
      int count_num = 10;
      while(count_num)
